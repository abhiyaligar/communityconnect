  ...
  return (
    <div className="flex min-h-screen bg-[#f7f9fb] font-sans antialiased">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 border-b border-[#e2e8f0] bg-white sticky top-0 z-30 flex items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4 flex-1">
            <Button
              variant="ghost"
              size="icon"
              className="lg:hidden h-10 w-10 text-[#0f172a]"
          ...
          {/* Right: Notifications, Privacy/Settings, Profile Avatar */}
        ...
        {/* Main Content Body */}
        <main className="flex-1 overflow-x-hidden p-6 md:p-8 max-w-[1280px] w-full mx-auto">
          {children}
        </main>
      </div>
    </div>
